...
public class EventSystem
{
    ...
    List<IEventReceiver> _initialSavedListener = new List<IEventReceiver>();
    List<IEventReceiver> _eventListener = new List<IEventReceiver>();
    List<IEventReceiver> _reNewListener = new List<IEventReceiver>();
